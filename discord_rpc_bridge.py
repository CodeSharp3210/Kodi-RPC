    ...
    try:
        ...
        if data.get("type") == "video":
            ...
            rpc.update(
                ...
                large_text=data.get("large_text", "Kodi Media Center"),
        ...
        # -------- MUSIC --------
            ...
            rpc.update(
                state=data.get("artist", "Unknown artist"),
                details=data.get("title", "Music"),
        ...
        # -------- MENU --------
            ...
            rpc.update(
                ...
                details=(f"Viewing the {data.get("details", "Menu")} Menu"),
                large_image=data.get("large_image", "kodi"),
                large_text=data.get("large_text", ""),
                buttons=data.get("buttons")
            )
