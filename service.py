...
# SERVICE ENTRYPOINT
# =========================
if addon.getSettingBool("rpc_enabled"):
    start_rpc()

while not monitor.abortRequested():
    # Legge lo stato attuale della setting
    rpc_enabled = addon.getSettingBool("rpc_enabled")

    if rpc_enabled and not rpc_running:
        start_rpc()  # avvia RPC se impostata ma non attiva
    elif not rpc_enabled and rpc_running:
        stop_rpc()   # ferma RPC se disattivata
